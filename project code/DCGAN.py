...
def generator_loss(disc_output, gene_output, features):
    ...
    K = int(gene_output.get_shape()[1])//int(features.get_shape()[1]) #K is 4 in our examples
    ...
    #generator's total loss = gen_l1_factor * generator_loss_1 + (1-gen_l1_factor) * generator_loss_2
...
def discriminator_loss(disc_real_output, disc_fake_output):
    ...
    # discriminator want its output close to 0 if input is a fake image(generated by generator)
